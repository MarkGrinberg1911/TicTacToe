  ...
  const draw = (index) => {
    if (data[index] === "" && winner === "") {
      ...
      if (!checkWin()) {
        ...
        for (let i = 8; i > 0; i -= 3) {
          if (data[i] === data[i - 2] && (data[i] === 'X' || data[i] === 'O') && !turn) {
            if (data[i - 1] === '') {
              data[i - 1] = "O";
              setData([...data]);
              turn = true;
        ...
        for (let i = 8; i > 5; i--) {
          if (data[i] === data[i - 6] && (data[i] === 'X' || data[i] === 'O') && !turn) {
            if (data[i - 3] === '') {
              data[i - 3] = "O";
              setData([...data]);
              turn = true;
        ...
        for (let i = 0; i < data.length; i += 3) {
          if (data[i] === data[i + 1] && (data[i] === 'X' || data[i] === 'O') && !turn) {
            if (data[i + 2] === '') {
              data[i + 2] = "O";
              setData([...data]);
              turn = true;
        ...
        for (let i = 0; i < 3; i++) {
          if (data[i] === data[i + 3] && (data[i] === 'X' || data[i] === 'O') && !turn) {
            if (data[i + 6] === '') {
              data[i + 6] = "O";
              setData([...data]);
              turn = true;
